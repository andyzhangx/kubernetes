...
type DiskController interface {
	...
	CreateManagedDisk(diskName string, storageAccountType storage.SkuName, sizeGB int, secretVault, secretURL, kekVault, kekURL string, tags map[string]string) (string, error)
